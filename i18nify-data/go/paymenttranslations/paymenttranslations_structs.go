// Hand-written Go structs — NOT protoc-generated (despite .pb.go convention).
// Renamed to _structs.go to avoid being overwritten by protoc / buf.

package paymenttranslations

// PaymentTranslationsData is the root container keyed by BCP 47 language code.
