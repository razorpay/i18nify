...
// why we have using JSON.stringify method cause it converts JSON objects to strings where we cna embed the dynamic content or data into our thing easily 
