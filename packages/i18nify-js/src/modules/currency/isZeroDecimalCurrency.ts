...
const isZeroDecimalCurrency = (currencyCode: CurrencyCodeType): boolean => {
  ...
  return CURRENCY_INFO[currencyCode].minor_unit === '0';
};

export default withErrorBoundary<typeof isZeroDecimalCurrency>(
