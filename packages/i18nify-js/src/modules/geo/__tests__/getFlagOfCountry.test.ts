...
describe('geo - getFlagOfCountry', () => {
  ...
  it('should throw an error for an invalid country code', () => {
    ...
    expect(() =>
      ...
      `The provided country code is invalid. The received value was: ${sampleInvalidCodes}. Please ensure you pass a valid country code.`,
    );
  });

  it('should throw an error for an empty string', () => {
    expect(() => getFlagOfCountry('' as CountryCodeType)).toThrow(
      'The provided country code is invalid. The received value was: . Please ensure you pass a valid country code.',
    );
  });
