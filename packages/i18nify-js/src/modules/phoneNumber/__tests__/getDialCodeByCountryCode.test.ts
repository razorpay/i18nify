...
describe('phoneNumber - getDialCodeByCountryCode', () => {
  ...
  it('should throw an error for invalid country codes', () => {
    ...
    expect(() => getDialCodeByCountryCode(invalidCountryCode as any)).toThrow(
      `The provided country code is invalid. The received value was: ${invalidCountryCode}. Please ensure you pass a valid country code. Check valid country codes here: https://github.com/razorpay/i18nify/blob/master/i18nify-data/country/metadata/data.json`,
    );
  });
});
