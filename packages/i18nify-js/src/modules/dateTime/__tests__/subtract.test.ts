...
describe('dateTime - subtract', () => {
  ...
  test('subtracts days correctly', () => {
    ...
    const result = subtract(date, {value: 10, unit: 'days'});
  ...
  test('subtracts months correctly', () => {
    ...
    const result = subtract(date, {value: 2, unit: 'months'});
  ...
  test('subtracts years correctly', () => {
    ...
    const result = subtract(date, {value: 2, unit: 'years'});
  ...
  test('handles leap year correctly when subtracting years', () => {
    ...
    const result = subtract(date, {value: 1, unit: 'years'});
  ...
  test('handles month-end correctly when subtracting months', () => {
    ...
    const result = subtract(date, {value: 1, unit: 'months'});
  ...
  test('throws error for invalid value', () => {
    ...
    expect(() => subtract(date, {value: Infinity, unit: 'days'})).toThrow(
  ...
  test('throws error for invalid date', () => {
    expect(() => subtract('invalid-date', {value: 1, unit: 'days'})).toThrow(
