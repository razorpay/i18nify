...
require (
	...
	github.com/razorpay/i18nify/i18nify-data/go/country/subdivisions v1.0.3
	...
	github.com/razorpay/i18nify/i18nify-data/go/paymenttranslations v1.0.0
	gopkg.in/yaml.v3 v3.0.1 // indirect
)

replace github.com/razorpay/i18nify/i18nify-data/go/paymenttranslations => ../../i18nify-data/go/paymenttranslations
