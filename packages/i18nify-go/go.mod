...
require (
	...
	github.com/razorpay/i18nify/i18nify-data/go/country/metadata v1.0.5-0.20260629132519-f27ccbeffefc
	github.com/razorpay/i18nify/i18nify-data/go/country/subdivisions v1.0.6
	github.com/razorpay/i18nify/i18nify-data/go/currency v0.0.0-20260709072628-116c38448727
