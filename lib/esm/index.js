...
var cleanPhoneNumber = function (phoneNumber) {
    ...
    return phoneNumber[0] === '+' ? "+".concat(cleanedPhoneNumber) : cleanedPhoneNumber;
};

var validatePhoneNumber = function (phoneNumber, countryCode) {
    var cleanedPhoneNumber = cleanPhoneNumber(phoneNumber.toString());
    if (!countryCode)
...
export { formatNumber$1 as formatNumber, formatNumberByParts$1 as formatNumberByParts, formatPhoneNumber$1 as formatPhoneNumber, getCurrencyList$1 as getCurrencyList, getCurrencySymbol$1 as getCurrencySymbol, parsePhoneNumber$1 as parsePhoneNumber, validatePhoneNumber$1 as validatePhoneNumber };
